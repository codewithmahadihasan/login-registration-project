...
import groovyWalkAnimation from "../Image/image2.json";
import {
  getAuth,
...
const LogIn = () => {
  ...
  const emailInput = (even) => {
    setUserEmail(even.target.value);
    return;
  };
  const forgetPass = () => {
  ...
  return (
    <div className="bg-gray-900 pt-1 md:flex justify-around items-center">
      <div className="w-5/12 mx-auto">
        <Lottie animationData={groovyWalkAnimation} loop={true}></Lottie>
      </div>
      <div className="w-full max-w-md p-4 mx-auto rounded-md shadow sm:p-8 bg-gray-900 text-gray-100">
        ...
        >
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <label name="email" className="block text-sm">
                Email address
              </label>
              <input
                onBlur={emailInput}
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                <label name="password" className="text-sm">
                  Password
                </label>
          ...
          <button
            type="submit"
            className="w-full px-8 py-3 name  font-semibold rounded-md bg-violet-400 text-gray-900"
          >
            Sign in
          </button>
        </form>
